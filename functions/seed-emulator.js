...
const products = [
        // Machine 001 products
        {
                ...
                trending: { isTrending: true, rank: 2, reason: 'Popular cola beverage' },
                salesData: { lastWeek: 87, lastMonth: 348, trend: 'up', percentChange: 15 },
                seasonalTag: 'summer',
        },
        {
                id: 'prod-001-pepsi',
                ...
                trending: { isTrending: false, rank: 0, reason: '' },
        ...
        },
        {
                ...
                trending: { isTrending: true, rank: 1, reason: 'Essential hydration - High demand' },
                salesData: { lastWeek: 95, lastMonth: 380, trend: 'up', percentChange: 12 },
                seasonalTag: 'summer',
        },
        {
        ...
        },
        {
                ...
                trending: { isTrending: true, rank: 3, reason: 'Popular lime soda' },
                salesData: { lastWeek: 55, lastMonth: 220, trend: 'up', percentChange: 9 },
                seasonalTag: 'summer',
        },
        {
                id: 'prod-002-redbull',
        ...
        },
        {
                ...
                trending: { isTrending: true, rank: 1, reason: 'Essential hydration - High demand' },
                salesData: { lastWeek: 95, lastMonth: 380, trend: 'up', percentChange: 8 },
                seasonalTag: 'summer',
        },
        {
                id: 'prod-002-oreo',
